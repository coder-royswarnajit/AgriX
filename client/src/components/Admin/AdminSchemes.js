...
export default function AdminSchemes() {
  ...
  function getschemedata() {
    fetch(`${process.env.REACT_APP_API_URL}/scheme/allactivescheme`)
  ...
  function handlemoreinfo(Schemeid) {
    fetch(`${process.env.REACT_APP_API_URL}/scheme/schemeinfo/${Schemeid}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handledelete(Schemeid) {
    fetch(`${process.env.REACT_APP_API_URL}/scheme/deletescheme/${Schemeid}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handleApplications(Schemeid) {
    fetch(
      `${process.env.REACT_APP_API_URL}/scheme/listofapprovedapplications/${Schemeid}`,
      {
        method: "GET",
      }
    )
  ...
  function handleApplicationsR(Schemeid) {
    fetch(
      `${process.env.REACT_APP_API_URL}/scheme/listofrejectedapplications/${Schemeid}`,
      {
        method: "GET",
      }
    )
  ...
  function handleApplicationsAnalysis(scheme) {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/scheme/farmerdetailsforscheme/${scheme.Schemeid}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    const getDistrict = async () => {
      const rescountry = await fetch(`${process.env.REACT_APP_API_URL}/scheme/list`);
  ...
  useEffect(() => {
    const getTaluka = async () => {
      const rescountry = await fetch(
        `${process.env.REACT_APP_API_URL}/scheme/list/${districnewdata2}`
      );
      const rescon = await rescountry.json();
      console.log(rescon);
  ...
  useEffect(() => {
    const getTaluka = async () => {
      const rescountry = await fetch(
        `${process.env.REACT_APP_API_URL}/scheme/list/${districnewdata3}`
      );
      const rescon = await rescountry.json();
      console.log(rescon);
  ...
  useEffect(() => {
    const getVillage = async () => {
      const rescountry = await fetch(
        `${process.env.REACT_APP_API_URL}/scheme/list/${districnewdata3}/${Taluka2}`
      );
      const rescon = await rescountry.json();
      console.log(rescon);
  ...
  useEffect(() => {
    ...
    const getstate = async () => {
      await fetch(
        `${process.env.REACT_APP_API_URL}/scheme/analysis/${Schemeid}/${districnewdata3}/${Taluka2}/${Villagename}`,
        {
          method: "GET",
        }
      )
