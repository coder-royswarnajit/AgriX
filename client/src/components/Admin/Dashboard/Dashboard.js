...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    const getstate = async () => {
      await fetch(
        `${process.env.REACT_APP_API_URL}/admin/analysis/${districnewdata3}/${Taluka2}/${Villagename}`,
        {
          method: "GET",
        }
      )
  ...
  function getdata() {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/admin/registeredfarmerdetails`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    const getstate = async () => {
      await fetch(`${process.env.REACT_APP_API_URL}/admin/mapdata/${Category}`, {
        method: "GET",
      })
        .then((response) => response.json())
        .then((data) => {
