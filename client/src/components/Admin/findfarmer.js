...
function Findfarmer() {
  ...
  function getFarmerdata() {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/admin/findallfarmers`)
  ...
  function handleSubmit1(e) {
    ...
    e.preventDefault();
    fetch(`${process.env.REACT_APP_API_URL}/admin/findfarmerbymobilenum/${Mobilenumfield}`, {
      method: "GET"
    })
      .then((response) => response.json())
  ...
  function handleSubmit2(e) {
    ...
    e.preventDefault();
    fetch(`${process.env.REACT_APP_API_URL}/admin/findfarmerbyid/${Uniqeidfield}`, {
      method: "GET"
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handleSubmit3(e) {
    ...
    e.preventDefault();
    fetch(`${process.env.REACT_APP_API_URL}/admin/findfarmerbyadharnum/${selectAdharnumfield}`, {
      method: "GET"
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handlemoreinfo(Id) {
    fetch(`${process.env.REACT_APP_API_URL}/admin/findfarmerbyid/${Id}`, {
      method: "GET"
    })
      .then((response) => response.json())
      .then((data) => {
