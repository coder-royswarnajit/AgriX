...
function Irrigationanalysis() {
  ...
  useEffect(() => {
    ...
    const getstate = async () => {
      await fetch(`${process.env.REACT_APP_API_URL}/area/cultivatedarea/${Districtname}`, {
        method: "GET",
      })
  ...
  useEffect(() => {
    ...
    const Year = [];
    const getstate = async () => {
      await fetch(`${process.env.REACT_APP_API_URL}/area/irigation/${Districtname}`, {
        method: "GET",
      })
        .then((response) => response.json())
        .then((data) => {
  ...
  useEffect(() => {
    ...
    const getstate = async () => {
      await
        ...
        fetch(`${process.env.REACT_APP_API_URL}/area/district_soil/${Districtname}`, {
          method: "GET"
        })
          .then((response) => response.json())
          .then((data) => {
