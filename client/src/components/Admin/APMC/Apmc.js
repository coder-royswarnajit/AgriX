...
function Apmc() {
  ...
  function getapmcdata() {
    fetch(`${process.env.REACT_APP_API_URL}/APMC/getall_traders`)
  ...
  function handleotherdetails(GST_No) {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/trader/get_trader_details/${GST_No}`)
      .then((response) => response.json())
      .then((data) => {
        console.warn(GST_No);
        setotherdata(data)
  ...
  function seller(GST_No) {
    console.log("seller")
    fetch(`${process.env.REACT_APP_API_URL}/trader/listofbill_trader/Seller/${GST_No}`)
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
  ...
  function Buyer(GST_No) {
    console.log("Buyer")
    fetch(`${process.env.REACT_APP_API_URL}/trader/listofbill_trader/Buyer/${GST_No}`)
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
