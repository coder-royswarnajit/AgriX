...
export default function AdminAppliedSchemes() {
  ...
  function getschemedata() {
    fetch(`${process.env.REACT_APP_API_URL}/scheme/appliedschemes`, {
      method: "GET",
      crossDomain: true,
    })
  ...
  function handleFarmerinfo(Application) {
    fetch(`${process.env.REACT_APP_API_URL}/admin/farmerinformation/${Application.Farmerid}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handleApplications(Schemeid) {
    fetch(`${process.env.REACT_APP_API_URL}/scheme/applicationsofscheme/${Schemeid}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  function handleApprove(Application) {
    fetch(
      `${process.env.REACT_APP_API_URL}/scheme/approve/${Schemeid}/${Application.Farmerid}`,
      {
        method: "POST",
      }
    )
  ...
  function handleReject(Application) {
    fetch(
      `${process.env.REACT_APP_API_URL}/scheme/reject/${Schemeid}/${Application.Farmerid}`,
      {
        method: "GET",
      }
    )
