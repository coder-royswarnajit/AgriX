...
function Myaccount() {
  ...
  function getschemedata() {
    fetch(`${process.env.REACT_APP_API_URL}/farm/farminfo/${JSON.parse(auth).Adharnum}`, {
      method: "GET",
      crossDomain: true,
    })
  ...
  function getApmcbilldata() {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/farmer/bills_farmers/${JSON.parse(auth).Farmerid}`, {
      method: "GET",
      crossDomain: true,
    })
      .then((response) => response.json())
  ...
  function getYielddata() {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/cropdata/crophistory/${UPINinfo}`, {
      method: "GET",
      crossDomain: true,
    })
      .then((response) => response.json())
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/cropdata/crophistoryform`,
        {
          method: "POST",
          headers: {
