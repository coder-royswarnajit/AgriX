...
export default function Schemes() {
  ...
  function getschemedata() {
    fetch(
      `${process.env.REACT_APP_API_URL}/farmer/eligibleschemes/${JSON.parse(auth).Category
  ...
  function handleApply(scheme) {
    fetch(
      `${process.env.REACT_APP_API_URL}/farmer/applyforscheme/${scheme.Schemeid}/${JSON.parse(auth).Farmerid}`,
      {
        method: "POST",
      }
    )
